...
class TabsController: UITabBarController {
    ...
    func makeQrListController() -> UINavigationController {
        ...
        vc.tabBarItem = UITabBarItem(title: nil, image: UIImage(systemName: "list.dash"), tag: 0)
    ...
    func makeDashboardController() -> UINavigationController {
        ...
        vc.tabBarItem = UITabBarItem(title: nil, image: UIImage(systemName: "qrcode"), tag: 1)
        let nc = UINavigationController(rootViewController: vc)
        return nc
    }
